...
/**
 * Configuration globale du système R.E.Mobiles
 * Adaptée pour utiliser l'ancienne base de données utilisateurs
 */
...
return [
    ...
    // Configuration de la base de données - UTILISER L'ANCIENNE CONFIGURATION
    'database' => [
        'host' => 'localhost',
        'port' => 3306,
    ...
    // Configuration des tables - UTILISER LES ANCIENNES TABLES
    'tables' => [
        'users' => 'admin_users', // Table utilisateurs existante
        'historiques' => 'historiques', // Table historiques existante
        'clients' => 'clients', // Table clients existante
        'devices' => 'devices', // Table devices existante
        'stock' => 'stock_articles', // Table stock existante
        'ventes' => 'ventes_historique' // Table ventes existante
    ],
    ...
    // Configuration des statuts - COMPATIBLES AVEC L'ANCIENNE VERSION
    'statuses' => [
        'devices' => [
    ...
    // Configuration des rôles - ADAPTÉE POUR L'ANCIENNE STRUCTURE
    'roles' => [
        'admin' => [
            'name' => 'Administrateur',
            'table' => 'admin_users', // Utiliser l'ancienne table
