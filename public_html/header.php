...
<aside class="nav-links" id="nav-links" aria-label="Menu principal">
  ...
  <div class="nav-section">
    ...
    <a href="../pages/admin.php" class="nav-btn btn-blue<?= is_active('admin.php', $currentUri) ?>">
      <svg class="nav-icon" viewBox="0 0 24 24" aria-hidden="true"><use href="#i-file"></use></svg>
      Devis / Factures
    </a>

    <a href="../pages/commandes.php" class="nav-btn btn-yellow<?= is_active('commandes.php', $currentUri) ?>">
    ...
    <a href="../pages/devices_list.php" class="nav-btn btn-green<?= is_active('devices_list.php', $currentUri) ?>">
  ...
  <div class="nav-footer">
    ...
    <a href="../pages/ventes_historique.php" class="nav-btn btn-blue<?= is_active('ventes_historique.php', $currentUri) ?>">
