...
// Table acomptes commandes (avec référence unique)
$conn->query("
...
// 1️⃣ Insertion de l’acompte (sans référence unique)
$stmt2 = $conn->prepare("
...
// 2️⃣ ID unique de l’acompte
$acompte_id = $stmt2->insert_id;
$stmt2->close();

// 3️⃣ Génération référence UNIQUE de l’acompte
$refAcompte = "CMD-AC-" . $commande_id . "-" . $acompte_id;

// 4️⃣ Mise à jour de l’acompte avec sa référence
$upd = $conn->prepare("
...
// 5️⃣ Historique des ventes (UNE référence = UN acompte)
